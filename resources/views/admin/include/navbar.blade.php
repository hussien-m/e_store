        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1" src="{{asset('dash-rtl/')}}/app-assets/images/slider/slider-2.png"
                ...
                <span class="mr-1">Hello,
                  <span class="user-name text-bold-700">full name</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  src="{{asset('dash-rtl/')}}/app-assets/images/portrait/small/avatar-s-2.png" /><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href=""><i class="ft ft-users"></i> حسابي </a>
                            <a class="dropdown-item" href="#"><i class="ft-image"></i>تغيير الصورة</a>
                            <a class="dropdown-item" href="#"><i class="ft-lock"></i>تغيير كلمة المرور</a>
                    ...
                    <li class="dropdown dropdown-language nav-item">
                        <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-sa"></i><span class="selected-language"></span></a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{asset('dash-rtl/')}}/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('dash-rtl/')}}/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
